...
import { StyleSheet, ImageBackground, View, TouchableOpacity, Animated, Dimensions, Easing } from 'react-native';
...
render(){
  return (
    <ImageBackground resizeMode='cover' source={require('./assets/phone.jpg')} style={styles.container}>    
